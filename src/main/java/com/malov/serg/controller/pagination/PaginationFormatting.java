package com.malov.serg.controller.pagination;
...
class FirstSecondNameType extends BasePaginationInfo implements Types {
    ...
    public Page<Employee> query() {
        ...
        return this.instance.findByFirstNameAndSecondNameContains(
...
class FirstType extends BasePaginationInfo implements Types {

    public FirstType(String firstName, String secondName, Pageable pageable) {
...
public class PaginationFormatting {
    ...
    public Map<String, PaginationMultiTypeValuesHelper> filterQuery(String firstName, String secondName, Pageable pageable) {
        ...
        if (firstName.length() == 0 && secondName.length() == 0) {
            ...
            typeInstance = new FirstType(firstName, secondName, pageable);
        }
